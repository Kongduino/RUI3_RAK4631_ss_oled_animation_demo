#include <ss_oled.h>
/*
You need to patch the ss_oled.h header file: currently RUI3 is missing stuff from pgmspace.
Right under
...
This uses the macro definitions from the RAK Arduino BSP. And fixes the issues.
*/
...
// These pin numbers are for the RAK4631R
...
void setup() {
  int rc;
  rc = oledInit(&ssoled, OLED_TYPE, OLED_ADDR, FLIP180, INVERT, USE_HW_I2C, SDA_PIN, SCL_PIN, RESET_PIN, 1000000L);
} /* setup() */
